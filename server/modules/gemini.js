...
/**
 * 
 * @param {String} theme a string that specifies the theme for the prompt, e.g. 'Sky temple', 'haunted house', 'medeival'
 * @param {Array} roomArray an array of strings of room coordinates formatted 'x.y'
 * @returns 
 */
